...
{
    public partial class Subject_Schedule_Entry : Form
    {
        public Subject_Schedule_Entry()
        {
            InitializeComponent();
        }
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            if (subjectSearch == true)
            {
                try
                {
                    OleDbConnection thisConnection2 = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\ll\Documents\Joe.accdb");
                    ...
                    if (conflict == false)
                    {
                        ...
                        thisRow["SFENDTIME"] = TimeEndTextPicker.Value.ToString("hh:mm tt");
        ...
        private void SubjectCodeTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
            {
                try
                {
                    ...
                    OleDbConnection thisConnection = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\ll\Documents\Joe.accdb");
                    thisConnection.Open();
